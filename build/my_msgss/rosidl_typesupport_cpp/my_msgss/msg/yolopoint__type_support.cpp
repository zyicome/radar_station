...
static const _Yolopoint_type_support_symbol_names_t _Yolopoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_msgss, msg, Yolopoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_msgss, msg, Yolopoint)),
  }
};
...
{
  return &::my_msgss::msg::rosidl_typesupport_cpp::Yolopoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_msgss, msg, Yolopoint)() {
  return get_message_type_support_handle<my_msgss::msg::Yolopoint>();
}
