...
class Init_Distpoint_confidence
{
public:
  explicit Init_Distpoint_confidence(::my_msgss::msg::Distpoint & msg)
  : msg_(msg)
  {}
  Init_Distpoint_x confidence(::my_msgss::msg::Distpoint::_confidence_type arg)
  {
...
public:
  ...
  {}
  Init_Distpoint_confidence id(::my_msgss::msg::Distpoint::_id_type arg)
  {
    msg_.id = std::move(arg);
    return Init_Distpoint_confidence(msg_);
  }
