...
{
public:
  explicit Init_Point_confidence(::my_msgss::msg::Point & msg)
  : msg_(msg)
  {}
  Init_Point_x confidence(::my_msgss::msg::Point::_confidence_type arg)
  {
...
public:
  ...
  {}
  Init_Point_confidence id(::my_msgss::msg::Point::_id_type arg)
  {
