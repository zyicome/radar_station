...
#include "my_msgss/msg/detail/point__rosidl_typesupport_fastrtps_c.h"
...
using _Point__ros_msg_type = my_msgss__msg__Point;
...
size_t get_serialized_size_my_msgss__msg__Point(
  const void * untyped_ros_message,
...
static uint32_t _Point__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_msgss__msg__Point(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_msgss
size_t max_serialized_size_my_msgss__msg__Point(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_msgss__msg__Point;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
static size_t _Point__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_msgss__msg__Point(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_msgss, msg, Point)() {
