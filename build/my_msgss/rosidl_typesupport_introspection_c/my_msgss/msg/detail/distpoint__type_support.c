...
static rosidl_typesupport_introspection_c__MessageMember my_msgss__msg__Distpoint__rosidl_typesupport_introspection_c__Distpoint_message_member_array[7] = {
  {
    "id",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_msgss__msg__Distpoint, confidence),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
