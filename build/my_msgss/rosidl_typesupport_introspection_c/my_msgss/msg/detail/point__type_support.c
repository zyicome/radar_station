...
static rosidl_typesupport_introspection_c__MessageMember my_msgss__msg__Point__rosidl_typesupport_introspection_c__Point_message_member_array[5] = {
  {
    "id",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_msgss__msg__Point, confidence),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
