...
private:
  void declareleftParameters()
  {
    ...
    double leftexposure_time = this->declare_parameter("leftexposure_time", 30000, leftparam_desc);
  ...
  void declarerightParameters()
    {
        ...
        double rightexposure_time = this->declare_parameter("rightexposure_time", 30000, rightparam_desc);
