...
private:
  void declareleftParameters()
  {
    ...
    leftanalog_gain = this->declare_parameter("leftanalog_gain", leftanalog_gain, leftparam_desc);
  ...
  void declarerightParameters()
    {
        ...
        rightanalog_gain = this->declare_parameter("rightanalog_gain", rightanalog_gain, rightparam_desc);
