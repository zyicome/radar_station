...
{   
    ...
    fardepth_sub_ = qnode->create_subscription<sensor_msgs::msg::Image>("/qt/fardepth_qimage", 1, std::bind(&qtNode::farDepthImageCallback, this, std::placeholders::_1));
    ...
    closedepth_sub_ = qnode->create_subscription<sensor_msgs::msg::Image>("/qt/closedepth_qimage", 1, std::bind(&qtNode::closeDepthImageCallback, this, std::placeholders::_1));
