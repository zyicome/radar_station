...
class Init_Yolopoint_confidence
{
public:
  explicit Init_Yolopoint_confidence(::my_msgss::msg::Yolopoint & msg)
  : msg_(msg)
  {}
  Init_Yolopoint_color confidence(::my_msgss::msg::Yolopoint::_confidence_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_Yolopoint_confidence height(::my_msgss::msg::Yolopoint::_height_type arg)
  {
    msg_.height = std::move(arg);
    return Init_Yolopoint_confidence(msg_);
  }
